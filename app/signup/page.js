  ...
  return (
    <main className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
      ...
      <div className="fixed inset-0 pointer-events-none z-0">
        <div className="absolute top-[-20%] left-[-10%] w-[500px] h-[500px] bg-blue-100 rounded-full opacity-40 animate-blob" />
        <div className="absolute bottom-[-10%] right-[-10%] w-[400px] h-[400px] bg-indigo-100 rounded-full opacity-30 animate-blob animation-delay-2000" />
      </div>
